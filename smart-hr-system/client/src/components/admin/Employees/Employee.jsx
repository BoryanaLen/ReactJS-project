    ...
    return(
        <div  >     
            <div className="profile-widget">
                ...
                <button className="action-icon dropdown-toggle employee-view-more" data-bs-toggle="dropdown" aria-expanded="true" ><i className="material-icons" onClick={() => onSetCurrentEmployeeClick(employee.id)}>more_vert</i></button>
